...
typedef struct {
    ...
    guint only_unallocated : 1; /* for Menuname: TRUE if show_empty is set */
    guint is_set : 1;           /* used by MenuMenu, for Menuname: TRUE if allow_inline is set */
    guint show_empty : 1;
    guint allow_inline : 1;
    guint inline_header : 1;
    guint inline_alias : 1;
    guint inline_header_is_set : 1; /* for Menuname */
    guint inline_alias_is_set : 1;  /* for Menuname */
    guint inline_limit_is_set : 1;  /* for Menuname; for MenuMenu is Legacy mark */
    guint nodisplay : 1;

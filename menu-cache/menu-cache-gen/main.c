...
static gboolean option_verbose(const gchar* option_name, const gchar* value, gpointer data, GError** error) {
    (void)option_name;
    (void)value;
    (void)data;
    (void)error;
...
GOptionEntry opt_entries[] = {
    ...
    */
    ...
    {"verbose", 'v', G_OPTION_FLAG_NO_ARG, G_OPTION_ARG_CALLBACK, (gpointer)(GOptionArgFunc)option_verbose,
     "Send debug messages to terminal", NULL},

...
class FolderViewListView : public QListView {
   ...
   public:
    ...
    inline QRect rectForIndex(const QModelIndex& index) const { return QListView::rectForIndex(index); }

    inline bool cursorOnSelectionCorner() const { return cursorOnSelectionCorner_; }

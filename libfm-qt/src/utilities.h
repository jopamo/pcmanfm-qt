...
LIBFM_QT_API bool changeFileName(const Fm::FilePath& path,
...
enum CreateFileType { CreateNewFolder, CreateNewTextFile, CreateWithTemplate };

LIBFM_QT_API void createFileOrFolder(CreateFileType type,
                                     FilePath parentDir,
                                     const TemplateItem* templ = nullptr,

...
class LIBFM_QT_API FolderModel : public QAbstractListModel {
    Q_OBJECT
   public:
    enum Role { FileInfoRole = Qt::UserRole, FileIsDirRole, FileIsCutRole };
   ...
   public:
    ...
    const std::shared_ptr<Fm::Folder>& folder() const { return folder_; }
    ...
    void setShowFullName(bool fullName) { showFullNames_ = fullName; }
   ...
   private:
    struct ThumbnailData {
        ThumbnailData(int size) : size_{size}, refCount_{1} {}

...
DndActionMenu::DndActionMenu(Qt::DropActions possibleActions, QWidget* parent)
    : QMenu(parent), copyAction(nullptr), moveAction(nullptr), linkAction(nullptr), cancelAction(nullptr) {
    ...
    addSeparator();
    cancelAction = addAction(copyAction || moveAction || linkAction ? tr("Cancel") : tr("Cannot drop here"));
}

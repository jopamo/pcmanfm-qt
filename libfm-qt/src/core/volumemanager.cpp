...
VolumeManager::VolumeManager() : QObject(), monitor_{g_volume_monitor_get(), false} {
    ...
    connect(job, &GetGVolumeMonitorJob::finished, this, &VolumeManager::onGetGVolumeMonitorFinished,

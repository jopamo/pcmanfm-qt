...
DirTreeModel::DirTreeModel(QObject* parent) : QAbstractItemModel(parent), showHidden_(false) {}
...
bool DirTreeModel::dropMimeData(const QMimeData* data,
...
bool DirTreeModel::canDropMimeData(const QMimeData* /*data*/,
                                   Qt::DropAction /*action*/,
                                   int /*row*/,
                                   int /*column*/,

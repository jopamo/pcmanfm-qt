...
class LIBFM_QT_API FileOperation : public QObject {
    Q_OBJECT
   public:
    enum Type { Copy, Move, Link, Delete, Trash, UnTrash, ChangeAttr };
   ...
   public:
    ...
    bool isRunning() const { return job_ && !isCancelled(); }
    ...
    Fm::FileOperationJob* job() { return job_; }
    ...
    static FileOperation* symlinkFiles(Fm::FilePathList srcFiles,
   ...
   private Q_SLOTS:
    ...
    void onJobFileExists(const FileInfo& src,
                         const FileInfo& dest,

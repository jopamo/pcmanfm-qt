...
class FilenameDialog : public QInputDialog {
   ...
   public:
    FilenameDialog(QWidget* parent = nullptr, Qt::WindowFlags flags = Qt::WindowFlags())
        : QInputDialog(parent, flags), selectExtension_(false) {}
    ...
    bool selectExtension() const { return selectExtension_; }

    void setSelectExtension(bool value) { selectExtension_ = value; }

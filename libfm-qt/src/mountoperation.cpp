...
void MountOperation::onAskPassword(GMountOperation* /*_op*/,
                                   gchar* message,
                                   gchar* default_user,
    ...
    */
    if (!pThis->tmpOp_) {                         // gather the needed info
        ...
        if (password) {
            ...
            g_mount_operation_set_password_save(pThis->op, g_mount_operation_get_password_save(pThis->tmpOp_));
        }
        g_mount_operation_set_anonymous(pThis->op, g_mount_operation_get_anonymous(pThis->tmpOp_));
...
void MountOperation::onShowProcesses(GMountOperation* /*_op*/,
                                     gchar* /*message*/,
                                     GArray* /*processes*/,
                                     GStrv /*choices*/,
                                     MountOperation* /*pThis*/) {
...
void MountOperation::onShowUnmountProgress(GMountOperation* /*_op*/,
                                           gchar* /*message*/,
                                           gint64 /*time_left*/,
                                           gint64 /*bytes_left*/,
                                           MountOperation* /*pThis*/) {

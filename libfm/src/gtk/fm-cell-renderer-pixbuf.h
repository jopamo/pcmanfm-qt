...
#define FM_CELL_RENDERER_PIXBUF(obj) \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_TYPE_CELL_RENDERER_PIXBUF, FmCellRendererPixbuf))
#define FM_CELL_RENDERER_PIXBUF_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST((klass), FM_TYPE_CELL_RENDERER_PIXBUF, FmCellRendererPixbufClass))
#define FM_IS_CELL_RENDERER_PIXBUF(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_TYPE_CELL_RENDERER_PIXBUF))
#define FM_IS_CELL_RENDERER_PIXBUF_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_TYPE_CELL_RENDERER_PIXBUF))

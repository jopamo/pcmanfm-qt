...
static gboolean write_image(GObject* image, const char* filename) {
    ...
    char* known_keys[] = {"tEXt::Thumb::URI",          "tEXt::Thumb::MTime",         "tEXt::Thumb::Size",
                          "tEXt::Thumb::Mimetype",     "tEXt::Description",          "tEXt::Software",
                          "tEXt::Thumb::Image::Width", "tEXt::Thumb::Image::Height", "tEXt::Thumb::Document::Pages",
                          "tEXt::Thumb::Movie::Length"};
    guint i, x;
...
static FmThumbnailLoaderBackend gtk_backend = {read_image_from_file, read_image_from_stream, write_image,
                                               scale_image,          rotate_image,           get_image_width,
                                               get_image_height,     get_image_text,         set_image_text};

...
#define FM_DIR_TREE_VIEW_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_TYPE_DIR_TREE_VIEW, FmDirTreeViewClass))
...
#define FM_DIR_TREE_VIEW_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), FM_TYPE_DIR_TREE_VIEW, FmDirTreeViewClass))

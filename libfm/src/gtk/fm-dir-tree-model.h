...
#define FM_DIR_TREE_MODEL_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_TYPE_DIR_TREE_MODEL, FmDirTreeModelClass))
...
#define FM_DIR_TREE_MODEL_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), FM_TYPE_DIR_TREE_MODEL, FmDirTreeModelClass))

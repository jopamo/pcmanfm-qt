...
#define FM_STANDARD_VIEW(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_STANDARD_VIEW_TYPE, FmStandardView))
#define FM_STANDARD_VIEW_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_STANDARD_VIEW_TYPE, FmStandardViewClass))
#define FM_IS_STANDARD_VIEW(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_STANDARD_VIEW_TYPE))
#define FM_IS_STANDARD_VIEW_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_STANDARD_VIEW_TYPE))

...
#define FM_PLACES_MODEL(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_TYPE_PLACES_MODEL, FmPlacesModel))
#define FM_PLACES_MODEL_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_TYPE_PLACES_MODEL, FmPlacesModelClass))
#define FM_IS_PLACES_MODEL(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_TYPE_PLACES_MODEL))
#define FM_IS_PLACES_MODEL_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_TYPE_PLACES_MODEL))
#define FM_PLACES_MODEL_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), FM_TYPE_PLACES_MODEL, FmPlacesModelClass))

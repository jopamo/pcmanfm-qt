...
#else
#define _exo_assert(expr) \
    G_STMT_START {        \
        (void)0;          \
    }                     \
    G_STMT_END
#define _exo_assert_not_reached() \
    G_STMT_START {                \
        (void)0;                  \
    }                             \
    G_STMT_END
#define _exo_return_if_fail(expr) \
    G_STMT_START {                \
        (void)0;                  \
    }                             \
    G_STMT_END
#define _exo_return_val_if_fail(expr, val) \
    G_STMT_START {                         \
        (void)0;                           \
    }                                      \
    G_STMT_END
...
#define _exo_slice_free1(block_size, mem_block)   \
    G_STMT_START {                                \

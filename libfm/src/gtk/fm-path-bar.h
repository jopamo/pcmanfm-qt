...
#define FM_PATH_BAR(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_TYPE_PATH_BAR, FmPathBar))
#define FM_PATH_BAR_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_TYPE_PATH_BAR, FmPathBarClass))
#define FM_IS_PATH_BAR(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_TYPE_PATH_BAR))
#define FM_IS_PATH_BAR_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_TYPE_PATH_BAR))
#define FM_PATH_BAR_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), FM_TYPE_PATH_BAR, FmPathBarClass))

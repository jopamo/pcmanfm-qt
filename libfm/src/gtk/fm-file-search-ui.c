...
static void __filesearch_glade_connect_func(GtkBuilder* builder,
                                            GObject* object,
                                            ...
                                            GConnectFlags flags,
                                            gpointer user_data) {
    static const char* handler_names[] = {"on_add_path_button_clicked",
    ...
    static GCallback handler_funcs[] = {G_CALLBACK(on_add_path_button_clicked),

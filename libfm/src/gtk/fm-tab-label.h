...
#define FM_TAB_LABEL(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_TYPE_TAB_LABEL, FmTabLabel))
#define FM_TAB_LABEL_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_TYPE_TAB_LABEL, FmTabLabelClass))
#define FM_IS_TAB_LABEL(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_TYPE_TAB_LABEL))
#define FM_IS_TAB_LABEL_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_TYPE_TAB_LABEL))

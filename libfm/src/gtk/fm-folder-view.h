...
#define FM_IS_FOLDER_VIEW(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_TYPE_FOLDER_VIEW))
#define FM_FOLDER_VIEW_GET_IFACE(obj) (G_TYPE_INSTANCE_GET_INTERFACE((obj), FM_TYPE_FOLDER_VIEW, FmFolderViewInterface))
 ...
 */
typedef void (*FmFolderViewUpdatePopup)(FmFolderView* fv,
                                        GtkWindow* window,
                                        GtkUIManager* ui,
...
struct _FmFolderViewInterface {
    ...
    void (*get_custom_menu_callbacks)(FmFolderView* fv, FmFolderViewUpdatePopup*, FmLaunchFolderFunc*);

...
#define FM_SIDE_PANE(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_TYPE_SIDE_PANE, FmSidePane))
#define FM_SIDE_PANE_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_TYPE_SIDE_PANE, FmSidePaneClass))
#define FM_IS_SIDE_PANE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_TYPE_SIDE_PANE))
#define FM_IS_SIDE_PANE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_TYPE_SIDE_PANE))
#define FM_SIDE_PANE_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), FM_TYPE_SIDE_PANE, FmSidePaneClass))
 ...
 */
typedef void (*FmSidePaneUpdatePopup)(FmSidePane* sp,
                                      GtkUIManager* ui,

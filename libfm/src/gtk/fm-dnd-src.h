...
#define FM_DND_SRC(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_TYPE_DND_SRC, FmDndSrc))
#define FM_DND_SRC_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_TYPE_DND_SRC, FmDndSrcClass))
#define FM_IS_DND_SRC(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_TYPE_DND_SRC))
#define FM_IS_DND_SRC_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_TYPE_DND_SRC))
...
#define fm_dnd_src_add_targets(widget, targets, n) \
    gtk_target_list_add_table(gtk_drag_source_get_target_list(widget), targets, n)

...
#define FM_CELL_RENDERER_TEXT(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_CELL_RENDERER_TEXT_TYPE, FmCellRendererText))
#define FM_CELL_RENDERER_TEXT_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST((klass), FM_CELL_RENDERER_TEXT_TYPE, FmCellRendererTextClass))
#define FM_IS_CELL_RENDERER_TEXT(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_CELL_RENDERER_TEXT_TYPE))
#define FM_IS_CELL_RENDERER_TEXT_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_CELL_RENDERER_TEXT_TYPE))

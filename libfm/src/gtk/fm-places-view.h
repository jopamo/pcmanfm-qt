...
#define FM_PLACES_VIEW(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_PLACES_VIEW_TYPE, FmPlacesView))
#define FM_PLACES_VIEW_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_PLACES_VIEW_TYPE, FmPlacesViewClass))
#define FM_IS_PLACES_VIEW(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_PLACES_VIEW_TYPE))
#define FM_IS_PLACES_VIEW_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_PLACES_VIEW_TYPE))

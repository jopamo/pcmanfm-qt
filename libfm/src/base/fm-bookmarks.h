...
#define FM_BOOKMARKS(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_BOOKMARKS_TYPE, FmBookmarks))
#define FM_BOOKMARKS_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_BOOKMARKS_TYPE, FmBookmarksClass))
#define FM_IS_BOOKMARKS(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_BOOKMARKS_TYPE))
#define FM_IS_BOOKMARKS_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_BOOKMARKS_TYPE))

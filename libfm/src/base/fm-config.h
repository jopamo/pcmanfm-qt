...
#define FM_CONFIG(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_CONFIG_TYPE, FmConfig))
#define FM_CONFIG_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_CONFIG_TYPE, FmConfigClass))
#define FM_IS_CONFIG(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_CONFIG_TYPE))
#define FM_IS_CONFIG_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_CONFIG_TYPE))

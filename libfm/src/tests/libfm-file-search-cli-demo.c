...
static GOptionEntry entries[] = {
    ...
    {"paths", 'p', 0, G_OPTION_ARG_STRING, &path_list, "paths to search through i.e. /usr/share/local:/usr/share",
     NULL},
    {"type", 'y', 0, G_OPTION_ARG_STRING, &target_type, "system string representation of type of files to search",
     NULL},
    ...
    {"content-ci", 'i', 0, G_OPTION_ARG_NONE, &case_insensitive_content, "enables case insensitive content searching",
     NULL},
...
int main(int argc, char** argv) {
    ...
    // g_string_append(search_uri,
    // "search://usr/share?recursive=1&name=*.mo&name_mode=widecard&show_hidden=0&name_case_sensitive=1");

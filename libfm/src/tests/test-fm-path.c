...
static void test_uri_parsing() {
    // test URIs
    TEST_PARSING(fm_path_new_for_uri, "file:///test/path/", "/", "test", "path");
    ...
    TEST_PARSING(fm_path_new_for_uri, "file://test/path", "file://test/", "path");

    TEST_PARSING(fm_path_new_for_uri, "http://test/path/", "http://test/", "path");

    TEST_PARSING(fm_path_new_for_uri, "http://test", "http://test/");
    ...
    TEST_PARSING(fm_path_new_for_uri, "mailto:test", "mailto:test");

    TEST_PARSING(fm_path_new_for_uri, "http://test/path/to/file", "http://test/", "path", "to", "file");

    // FIXME: is this ok?
    TEST_PARSING(fm_path_new_for_uri, "http://test/path/to/file?test_arg=xx", "http://test/",
                 "path/to/file?test_arg=xx");

    // test user name, password, and port
    TEST_PARSING(fm_path_new_for_uri, "ftp://user@host", "ftp://user@host/");

    TEST_PARSING(fm_path_new_for_uri, "ftp://user:pass@host", "ftp://user:pass@host/");

    TEST_PARSING(fm_path_new_for_uri, "ftp://user@host:21", "ftp://user@host:21/");

    TEST_PARSING(fm_path_new_for_uri, "ftp://user:pass@host:21", "ftp://user:pass@host:21/");

    TEST_PARSING(fm_path_new_for_uri, "ftp://user:pass@host:21/path", "ftp://user:pass@host:21/", "path");
    ...
    TEST_PARSING(fm_path_new_for_uri, "computer:", "computer:///");
    ...
    TEST_PARSING(fm_path_new_for_uri, "computer://device", "computer:///", "device");

    TEST_PARSING(fm_path_new_for_uri, "computer:///device", "computer:///", "device");

    TEST_PARSING(fm_path_new_for_uri, "trash:", "trash:///");
    ...
    TEST_PARSING(fm_path_new_for_uri, "trash:/file/", "trash:///", "file");
    ...
    TEST_PARSING(fm_path_new_for_uri, "trash:///file/../test", "trash:///", "test");
    ...
    /*
        ...
        TEST_PARSING(fm_path_new_for_uri, "menu:///");
    */
    TEST_PARSING(fm_path_new_for_uri, "menu://applications/", "menu://applications/");

    TEST_PARSING(fm_path_new_for_uri, "menu://applications/xxxx", "menu://applications/", "xxxx");

    TEST_PARSING(fm_path_new_for_uri, "menu://applications/xxxx/", "menu://applications/", "xxxx");

    TEST_PARSING(fm_path_new_for_uri, "menu://settings/xxxx/", "menu://settings/", "xxxx");

    TEST_PARSING(fm_path_new_for_uri, "menu://settings", "menu://settings/");
...
static void test_path_parsing() {
    TEST_PARSING(fm_path_new_for_path, "/test/path", "/", "test", "path");
    ...
    TEST_PARSING(fm_path_new_for_path, "/test/../path", "/", "path");

    TEST_PARSING(fm_path_new_for_path, "/../path", "/", "path");

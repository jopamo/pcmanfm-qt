...
#define FM_IS_FILE_OPS_JOB(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_FILE_OPS_JOB_TYPE))
#define FM_IS_FILE_OPS_JOB_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_FILE_OPS_JOB_TYPE))

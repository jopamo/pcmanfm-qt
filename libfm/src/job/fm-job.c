...
enum { FINISHED, ERROR, CANCELLED, ASK, N_SIGNALS };
...
static void fm_job_class_init(FmJobClass* klass) {
     ...
     */
    signals[FINISHED] =
        g_signal_new("finished", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST, G_STRUCT_OFFSET(FmJobClass, finished),
    ...
    signals[ERROR] = g_signal_new("error", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_LAST,
                                  G_STRUCT_OFFSET(FmJobClass, error), NULL /*fm_job_error_accumulator*/, NULL,
     ...
     */
    signals[CANCELLED] =
        g_signal_new("cancelled", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST, G_STRUCT_OFFSET(FmJobClass, cancelled),
                     NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);
     ...
     * Since: 0.1.0
     */
    signals[ASK] = g_signal_new("ask", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(FmJobClass, ask),
                                g_signal_accumulator_first_wins, NULL, fm_marshal_INT__POINTER_POINTER, G_TYPE_INT, 2,

...
#define FM_DEEP_COUNT_JOB(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_DEEP_COUNT_JOB_TYPE, FmDeepCountJob))
#define FM_DEEP_COUNT_JOB_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_DEEP_COUNT_JOB_TYPE, FmDeepCountJobClass))
#define FM_IS_DEEP_COUNT_JOB(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_DEEP_COUNT_JOB_TYPE))
#define FM_IS_DEEP_COUNT_JOB_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_DEEP_COUNT_JOB_TYPE))

...
#define FM_SIMPLE_JOB(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_TYPE_SIMPLE_JOB, FmSimpleJob))
#define FM_SIMPLE_JOB_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_TYPE_SIMPLE_JOB, FmSimpleJobClass))
#define FM_IS_SIMPLE_JOB(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_TYPE_SIMPLE_JOB))
#define FM_IS_SIMPLE_JOB_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_TYPE_SIMPLE_JOB))

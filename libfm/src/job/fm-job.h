...
#define FM_JOB(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), FM_TYPE_JOB, FmJob))
#define FM_JOB_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), FM_TYPE_JOB, FmJobClass))
#define FM_IS_JOB(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_TYPE_JOB))
#define FM_IS_JOB_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_TYPE_JOB))

...
#define G_IMPLEMENT_INTERFACE_DYNAMIC(TYPE_IFACE, iface_init)                                                \
    {                                                                                                        \
        const GInterfaceInfo g_implement_interface_info = {(GInterfaceInitFunc)iface_init, NULL, NULL};      \
...
G_DEFINE_DYNAMIC_TYPE_EXTENDED(FmAppLookup,
                               fm_app_lookup,
                               G_TYPE_OBJECT,
                               0,
...
void fm_app_lookup_register(GIOModule* module) {
    ...
    g_io_extension_point_implement(G_DESKTOP_APP_INFO_LOOKUP_EXTENSION_POINT_NAME, FM_TYPE_APP_LOOKUP,
                                   "libfm-applookup", priority);

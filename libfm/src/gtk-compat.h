...
#define gdk_window_get_device_position(win, dev, xptr, yptr, mptr) gdk_window_get_pointer(win, xptr, yptr, mptr)
#else
...
#define gdk_drag_context_get_source_window(drag_context) drag_context->source_window
#define gdk_drag_context_get_selected_action(drag_context) drag_context->action
#define gdk_drag_context_get_actions(drag_context) drag_context->actions
#define gdk_drag_context_get_suggested_action(drag_context) drag_context->suggested_action

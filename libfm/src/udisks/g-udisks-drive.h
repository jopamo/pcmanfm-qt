...
#define G_UDISKS_DRIVE(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), G_TYPE_UDISKS_DRIVE, GUDisksDrive))
#define G_UDISKS_DRIVE_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), G_TYPE_UDISKS_DRIVE, GUDisksDriveClass))
#define G_IS_UDISKS_DRIVE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_TYPE_UDISKS_DRIVE))
#define G_IS_UDISKS_DRIVE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), G_TYPE_UDISKS_DRIVE))
#define G_UDISKS_DRIVE_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), G_TYPE_UDISKS_DRIVE, GUDisksDriveClass))

...
#define G_UDISKS_VOLUME_MONITOR(obj) \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), G_UDISKS_VOLUME_MONITOR_TYPE, GUDisksVolumeMonitor))
#define G_UDISKS_VOLUME_MONITOR_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST((klass), G_UDISKS_VOLUME_MONITOR_TYPE, GUDisksVolumeMonitorClass))
#define G_IS_UDISKS_VOLUME_MONITOR(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_UDISKS_VOLUME_MONITOR_TYPE))
#define G_IS_UDISKS_VOLUME_MONITOR_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), G_UDISKS_VOLUME_MONITOR_TYPE))

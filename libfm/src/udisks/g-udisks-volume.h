...
#define G_UDISKS_VOLUME(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), G_TYPE_UDISKS_VOLUME, GUDisksVolume))
#define G_UDISKS_VOLUME_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), G_TYPE_UDISKS_VOLUME, GUDisksVolumeClass))
#define G_IS_UDISKS_VOLUME(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_TYPE_UDISKS_VOLUME))
#define G_IS_UDISKS_VOLUME_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), G_TYPE_UDISKS_VOLUME))
#define G_UDISKS_VOLUME_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), G_TYPE_UDISKS_VOLUME, GUDisksVolumeClass))

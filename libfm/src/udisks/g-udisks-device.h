...
#define G_UDISKS_DEVICE(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), G_TYPE_UDISKS_DEVICE, GUDisksDevice))
#define G_UDISKS_DEVICE_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), G_TYPE_UDISKS_DEVICE, GUDisksDeviceClass))
#define G_IS_UDISKS_DEVICE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_TYPE_UDISKS_DEVICE))
#define G_IS_UDISKS_DEVICE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), G_TYPE_UDISKS_DEVICE))
#define G_UDISKS_DEVICE_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), G_TYPE_UDISKS_DEVICE, GUDisksDeviceClass))
